...
() => {
  ...
  it('TASY_TC_70248	Verify if a screen asking to change the password is displayed in the functionality.', function () {
    HomePage.go()
  ...
  it('TASY_TC_71354	Change password by SMS in the plataform indicated.', function () {
    HomePage.go()
  ...
  it('TASY_TC_71356	Change password by SMS - Expired Link  in the plataform indicated.', function () {
    HomePage.go()
    HomePage.goToForgotPass()
    HomePage.enterEmail()
    HomePage.clickNext()
    ...
    cy.task('queryDb', `select ds_chave_sms from teste.wsuite_usuario where nm_usuario_web like'%jeffmonteiroo%'`)
      .then((result) => {
        ...
        //cy.get('div[class="c-wizard-step c-wizard-step--done c-wizard-step--current"]').should('have text', 'Código inválido. Verifique se o código está correto e tente novamente.')
      })
  })
